...
function Settings() {
  ...
  return (
    <>
      ...
      <div className="text-gray-600">Edit store detials</div>
      <form
      ...
      >
        ...
        <input
          ...
          id="name"
          {...register("name")}
          className="w-96 rounded-lg border border-gray-300 p-2 focus:outline-none"
          required
        />
        <button
          type="submit"
        ...
        <button
          className="mt-5 rounded-lg border-2 border-red-600 px-3 py-2 font-semibold text-red-600 focus:outline-none"
          type="button"
